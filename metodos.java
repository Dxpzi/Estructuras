...
public class metodos {
    ...
    public ObjVehiculo[] LlenarRegirtros(ObjVehiculo[] r) // r: Registros

    {
        for (int i = 0; i < r.length; i++) {

            ObjVehiculo o = new ObjVehiculo(); // o: Objeto
    ...
    public void MostrarRegistros(ObjVehiculo[] r) {
        for (int i = 0; i < r.length; i++) {
            ...
            System.out.println("Tipo vehículo: " + r[i].getTipo());
            ...
            System.out.println("Número de celda: " + r[i].getNumeroCelda());
